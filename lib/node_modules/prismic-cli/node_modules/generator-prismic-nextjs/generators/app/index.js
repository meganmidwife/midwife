...
class default_1 extends prismic_yeoman_generator_1.default {
    /**
    ...
    async prompting() {
        ...
        if (this.options.slicemachine === undefined) {
            this.options.slicemachine = await inquirer.prompt([{
                    name: 'slicemachine',
                    type: 'confirm',
                    default: true,
    ...
    async default() {
        const opts = Object.assign({ framework: 'nextjs', force: this.force, domain: this.domain, prismic: this.prismic, path: this.destinationRoot(), pm: this.pm, existingRepo: this.existingRepo }, this.options);
    ...
    async writing() {
        this.fs.copyTpl(this.templatePath('**'), this.destinationPath(), { domain: this.domain }, undefined, { globOptions: { dot: true } });
        const pkjJson = {
            name: this.domain,
            version: '0.1.0',
            private: true,
