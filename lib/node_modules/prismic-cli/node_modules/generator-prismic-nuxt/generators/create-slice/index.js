...
class CreateSlice extends prismic_yeoman_generator_1.default {
    ...
    async writing() {
        ...
        if (hasLibIndex) {
            ...
            this.fs.copyTpl(this.templatePath('library/index.js'), libIndex, { sliceName: this.answers.sliceName });
        }
