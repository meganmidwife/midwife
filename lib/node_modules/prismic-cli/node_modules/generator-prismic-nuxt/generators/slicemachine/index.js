...
const modify_nuxt_config_1 = require("./modify-nuxt-config");
const chalk = require("chalk");
const { SM_FILE } = require('sm-commons/consts');
class PrismicNuxt extends prismic_yeoman_generator_1.default {
    ...
    async writing() {
        ...
        const updatedConfig = modify_nuxt_config_1.default(config, this.domain);
